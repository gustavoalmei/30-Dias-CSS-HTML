...
##  Dia 20 ✔️
- [Codigo](https://github.com/gustavoalmei/30-Dias-CSS-HTML/tree/main/Dia%2020)
### Foi usado:
- ```transform;```
- ```overflow;```
- ```::after;```
...
##  Dia 24 ✔️
- [Codigo](https://github.com/gustavoalmei/30-Dias-CSS-HTML/tree/main/Dia%2024)
### Foi usado:
- ```animation;```
- ```transform;```
...
##  Dia 26 ✔️
- [Codigo](https://github.com/gustavoalmei/30-Dias-CSS-HTML/tree/main/Dia%2026)
### Foi usado:
- ```animation;```
- ```transform;```
